...
import static com.yjhs.cbsd.widget.shadow.ShadowDrawable.Builder.DEFAULT_SHADOW_COLOR;
...
public class ShadowDrawable extends Drawable {
    ...
    public static ShadowDrawable fromAttributeSet(Context context, AttributeSet attrs) {
        ...
        int shadowRadius = typedArray.getDimensionPixelSize(R.styleable.ShadowDrawable_sd_shadowRadius, context.getResources().getDimensionPixelSize(R.dimen.default_sd_shadow_radius));
        ...
        int shapeRadius = typedArray.getDimensionPixelSize(R.styleable.ShadowDrawable_sd_shapeRadius, context.getResources().getDimensionPixelSize(R.dimen.default_sd_shape_radius));
        ...
        int bgColor = typedArray.getColor(R.styleable.ShadowDrawable_sd_bgColor,context.getResources().getColor(R.color.xui_config_color_white));
