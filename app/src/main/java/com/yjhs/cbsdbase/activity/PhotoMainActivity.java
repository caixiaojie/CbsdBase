    ...
    public void init(@Nullable Bundle savedInstanceState) {
        ...
        permissions.request(Manifest.permission.WRITE_EXTERNAL_STORAGE).subscribe(new Observer<Boolean>() {
            ...
            public void onNext(Boolean aBoolean) {
                if (aBoolean) {
                    PictureFileUtils.deleteCacheDirFile(PhotoMainActivity.this, PictureMimeType.ofImage());
                } else {
    ...
    public void onCheckedChanged(RadioGroup group, @IdRes int checkedId) {
        switch (checkedId) {
            ...
            case R.id.rb_white_style:
                ...
                upResId = R.mipmap.orange_arrow_up;
                downResId = R.mipmap.orange_arrow_down;
                isOpenStyleCheckNumMode = false;
                break;
